...
namespace TeslaFleetManagementApi.Standard.Controllers
{
    ...
    public class OauthAuthorizationController : BaseController
    {
        ...
        public ApiResponse<Models.OauthToken> RequestTokenOauth2(
                string authorization,
                string code,
                string redirectUri,
                Dictionary<string, object> fieldParameters = null)
            => CoreHelper.RunTask(RequestTokenOauth2Async(authorization, code, redirectUri, fieldParameters));
        ...
        /// <returns>Returns the ApiResponse of Models.OauthToken response from the API call.</returns>
        public async Task<ApiResponse<Models.OauthToken>> RequestTokenOauth2Async(
                string authorization,
                string code,
                string redirectUri,
                Dictionary<string, object> fieldParameters = null,
        ...
        /// <param name="fieldParameters">Additional optional form parameters are supported by this endpoint.</param>
        /// <returns>Returns the ApiResponse of Models.OauthToken response from the API call.</returns>
        public ApiResponse<Models.OauthToken> RefreshTokenOauth2(
                string authorization,
                string refreshToken,
                string scope = null,
                Dictionary<string, object> fieldParameters = null)
            => CoreHelper.RunTask(RefreshTokenOauth2Async(authorization, refreshToken, scope, fieldParameters));
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the ApiResponse of Models.OauthToken response from the API call.</returns>
        public async Task<ApiResponse<Models.OauthToken>> RefreshTokenOauth2Async(
                string authorization,
                string refreshToken,
                string scope = null,
                Dictionary<string, object> fieldParameters = null,
